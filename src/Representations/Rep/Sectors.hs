...
import Representations.Rep.HomBlock (CoeffBlock, HomBlockDim, applyBlock)
...
applySector
  :: forall m n d. ApplySectorC m n d
  => CoeffBlock m n
  -> (C n ⊗ C d)
  -> (C m ⊗ C d)
applySector blk v =
...
type ApplyEndoSectors (g :: Group) (r :: Rep g) =
...
instance
  ( KnownNat j, ApplySectorC n n (IrrepDim SU2 j)
